...
// COMPONENTE SLOT INDIVIDUAL REESTRUTURADO PARA RECEBER PROPS DIRETAS
    ...
    <article className={styles.gallerySection}>
      ...
      <section className={styles.squadBlock}>
        ...
        <div className={styles.gridContainer}>
          ...
          <GridSlot src={duda} caption="Cada membro é fundamental." absoluteIndex={2} localIndex={2} />
          <GridSlot src={mulherad} caption="Cada membro é fundamental." absoluteIndex={2} localIndex={2} />
          <GridSlot src={baterista01} caption="Cada membro é fundamental." absoluteIndex={2} localIndex={2} />
      ...
      <section className={styles.squadBlock}>
        ...
        <div className={styles.gridContainer}>
          <GridSlot src={amigos04} caption="Servindo ao Próximo com alegria." absoluteIndex={3} localIndex={0} />
          <GridSlot src={amigos05} caption="Comunhão e amizade que fortalecem." absoluteIndex={4} localIndex={1} />
          <GridSlot src={amigos01} caption="Servindo com alegria e trabalho em equipe." absoluteIndex={5} localIndex={2} />
          <GridSlot src={bastidores04} caption="Servindo com alegria e trabalho em equipe." absoluteIndex={5} localIndex={2} />
          <GridSlot src={bastidores05} caption="Servindo com alegria e trabalho em equipe." absoluteIndex={5} localIndex={2} />
          <GridSlot src={bastidores06} caption="Servindo com alegria e trabalho em equipe." absoluteIndex={5} localIndex={2} />
        </div>
      </section>
      ...
      <section className={styles.squadBlock}>
        ...
        <div className={styles.gridContainer}>
          <GridSlot src={encontrista02}  caption="União e força entre os jovens." absoluteIndex={6} localIndex={0} />
          <GridSlot src={encontrista03} caption="Alegria que contagia a todos." absoluteIndex={7} localIndex={1} />
          <GridSlot src={encontrista04}  caption="Novas amizades, novas história" absoluteIndex={8} localIndex={2} />
          <GridSlot src={jovem}  caption="Novas amizades, novas história" absoluteIndex={8} localIndex={2} />
          <GridSlot src={jovem2}  caption="Novas amizades, novas história" absoluteIndex={8} localIndex={2} />
          <GridSlot src={jovem3}  caption="Novas amizades, novas história" absoluteIndex={8} localIndex={2} />
        </div>
      </section>
      ...
      <section className={styles.squadBlock}>
        ...
        <div className={styles.gridContainer}>
          <GridSlot src={ministracao} caption="Alinhamento estratégico ministerial." absoluteIndex={9} localIndex={0} />
          <GridSlot src={ministracao02} caption="Fortalecendo nossa identidade em Deus." absoluteIndex={10} localIndex={1} />
          <GridSlot src={amigos03} caption="União tática das lideranças." absoluteIndex={11} localIndex={2} />
          <GridSlot src={adoracao01} caption="Cada membro é fundamental." absoluteIndex={2} localIndex={2} />
          <GridSlot src={adoracao02} caption="Cada membro é fundamental." absoluteIndex={2} localIndex={2} />
          <GridSlot src={adoracao03} caption="Cada membro é fundamental." absoluteIndex={2} localIndex={2} />
        </div>
      </section>
      ...
      <section className={styles.squadBlock}>
        ...
        <div className={styles.gridContainer}>
          <GridSlot src={abraco01} caption="Acolhimento e ministração profunda." absoluteIndex={12} localIndex={0} />
          <GridSlot src={ministracao} caption="O agir que quebra as barreiras." absoluteIndex={13} localIndex={1} />
          <GridSlot src={oracao04} caption="Firmes em oração sobre o mesmo fundamento." absoluteIndex={14} localIndex={2} />
        </div>
      </section>

      {/* SEÇÃO INFERIOR DO ALICERCE */}
      <LegacySection absoluteIndex={15} />
    </article>
  );
}